...
\newcommand{\myname}{Alexander Mamani}
\newcommand{\studentID}{23329823}
\newcommand{\mytitle}{Evaluation of MAC Policy Effectiveness Based on LSM in Kernel Space for Protecting IoT Devices}
